...
- Your login: is _SNCUST013
- The password is _SNCUST013
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate element DOGGOS13 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate element DOGGOS13 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset _MFCUST013.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST013.PUBLIC.JCL(NDRUNDOG)" --vasc`
...
Username: _JENKINSCUST013
Password: Mfuser13@26
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-13.git`
